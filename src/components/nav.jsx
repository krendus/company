    ...
    <div className='h-[60px] px-3 md:px-6 py-3 w-full bg-white shadow items-center justify-between flex z-30 absolute top-0 left-0'>
      ...
      <div className='flex items-center'>
        <div  className='flex items-center gap-x-2 pr-4 border-r border-[#DEE0E6]'>
          <button className='bg-primary rounded-md  px-3 md:px-6 py-2 text-sm text-white'>Upgrade</button>
        ...
        <div className='flex px-2 gap-x-2 md:gap-x-5 items-center'>
          <div className='group flex items-center relative'>
            ...
            <div className='hidden group-hover:flex flex-col gap-y-5 min-h-[300px] max-h-[300px] absolute right-0 top-[40px] w-[400px] p-5 rounded-lg bg-white shadow-modal'>
              <ActivityCard 
